...
var SearchApp = require('./react/SearchApp');

React.render(React.createElement(SearchApp, null), document.getElementById('container'));

},{"./react/SearchApp":162,"react":159}],2:[function(require,module,exports){
/*!
...
var Loading = (function (_React$Component) {
    ...
    _createClass(Loading, [{
        ...
        key: 'render',
        value: function render() {
            return _React2['default'].createElement('div', { className: 'none' });
        }
    }]);
...
},{"jquery":2,"nprogress":4,"react":159}],162:[function(require,module,exports){
'use strict';
...
var SearchApp = (function (_React$Component) {
    function SearchApp() {
        ...
        _get(Object.getPrototypeOf(SearchApp.prototype), 'constructor', this).call(this);
        this.state = {
            items: [],
            badges: {
                total: 0,
    ...
    _createClass(SearchApp, [{
        ...
        key: 'loadMoreHandler',
        value: function loadMoreHandler(e) {
            e.preventDefault();
            var $this = this;
        ...
        value: function render() {
            return _React2['default'].createElement(
                ...
                _React2['default'].createElement(
                    'h1',
                    null,
                    _React2['default'].createElement('img', { className: 'logo img-circle' }),
                    ' 搜索'
                ),
                _React2['default'].createElement(
                    'p',
                    ...
                    _React2['default'].createElement(
                        ...
                        _React2['default'].createElement('input', { type: 'text', className: 'form-control', placeholder: '输入要查询的关键字', value: this.state.keyword, onChange: this.changeHandler.bind(this) })
                    )
                ),
                _React2['default'].createElement(Alert, { type: 'danger', className: !this.state.showError ? 'hidden' : '', text: this.state.error }),
                _React2['default'].createElement(SearchTabControl, { badges: this.state.badges, selected: this.state.currentTab, className: !this.state.showResult ? 'hidden' : '', onClick: this.tabChangeHandler.bind(this) }),
                _React2['default'].createElement(SearchResultList, { items: this.state.items, className: !this.state.showResult ? 'hidden' : '' }),
                _React2['default'].createElement(SearchLoadMore, { className: this.state.showResult && !this.state.lastPage ? '' : 'hidden', onClick: this.loadMoreHandler.bind(this) }),
...
},{"./Alert":160,"./Loading":161,"./SearchLoadMore":163,"./SearchResultList":164,"./SearchTabControl":166,"jquery":2,"react":159}],163:[function(require,module,exports){
'use strict';
...
var SearchLoadMore = (function (_React$Component) {
    function SearchLoadMore(props) {
        _classCallCheck(this, SearchLoadMore);

        _get(Object.getPrototypeOf(SearchLoadMore.prototype), 'constructor', this).call(this, props);
    }

    _inherits(SearchLoadMore, _React$Component);

    _createClass(SearchLoadMore, [{
        key: 'render',
        value: function render() {
            var className = 'btn btn-default ' + this.props.className;
            return _React2['default'].createElement(
                'button',
                { className: className, type: 'button', onClick: this.props.onClick },
                '加载更多...'
            );
        }
    }]);
    ...
    _createClass(SearchResultList, [{
        ...
        value: function render() {
            var itemNodes = this.props.items.map(function (item) {
                return _React2['default'].createElement(SearchResultListItem, { key: item.id, item: item });
            });
...
},{"./SearchResultListItem":165,"react":159}],165:[function(require,module,exports){
"use strict";
...
var SearchResultListItem = (function (_React$Component) {
    function SearchResultListItem() {
        _classCallCheck(this, SearchResultListItem);
...
var SearchTabControl = (function (_React$Component) {
    function SearchTabControl(props) {
        _classCallCheck(this, SearchTabControl);

        _get(Object.getPrototypeOf(SearchTabControl.prototype), "constructor", this).call(this, props);
    }

    _inherits(SearchTabControl, _React$Component);

    _createClass(SearchTabControl, [{
        key: "render",
        value: function render() {
            return _React2["default"].createElement(
                "div",
                ...
                _React2["default"].createElement(
                    ...
                    _React2["default"].createElement(
                        "li",
                        { role: "presentation", className: this.props.selected == 0 ? "active" : "" },
                        _React2["default"].createElement(
                            "a",
                            { href: "javascript:void(0);", "data-tab": "0" },
                            _React2["default"].createElement(
                                "span",
                                { "data-tab": "0" },
                                "全部  "
                            ...
                            _React2["default"].createElement(
                                "span",
                                { className: "badge", "data-tab": "0" },
                                this.props.badges.total
                            )
                        )
                    ),
                    _React2["default"].createElement(
                        "li",
                        { role: "presentation", className: this.props.selected == 1 ? "active" : "" },
                        _React2["default"].createElement(
                            "a",
                            { href: "javascript:void(0);", "data-tab": "1" },
                            _React2["default"].createElement(
                                "span",
                                { "data-tab": "1" },
                                "用户  "
                            ...
                            _React2["default"].createElement(
                                "span",
                                { "data-tab": "1", className: "badge" },
                                this.props.badges.users
                            )
                        )
                    ),
                    _React2["default"].createElement(
                        "li",
                        { role: "presentation", className: this.props.selected == 2 ? "active" : "" },
                        _React2["default"].createElement(
                            "a",
                            { href: "javascript:void(0);", "data-tab": "2" },
                            _React2["default"].createElement(
                                "span",
                                { "data-tab": "2" },
                                "群组  "
                            ...
                            _React2["default"].createElement(
                                "span",
                                { "data-tab": "2", className: "badge" },
                                this.props.badges.groups
                            )
                        )
                    ),
                    _React2["default"].createElement(
                        "li",
                        { role: "presentation", className: this.props.selected == 3 ? "active" : "" },
                        _React2["default"].createElement(
                            "a",
                            { href: "javascript:void(0);", "data-tab": "3" },
                            _React2["default"].createElement(
                                "span",
                                { "data-tab": "3" },
                                "帖子  "
                            ...
                            _React2["default"].createElement(
                                "span",
                                { "data-tab": "3", className: "badge" },
                                this.props.badges.threads
                            )
                        )
                    )
                )
    ...
    return SearchTabControl;
})(_React2["default"].Component);

exports["default"] = SearchTabControl;
module.exports = exports["default"];
